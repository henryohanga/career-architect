---
description: Regenerate PDF/DOCX/TXT artifacts from an existing resume.md without regenerating content
argument-hint: [folder name, company/role, or template]
---
